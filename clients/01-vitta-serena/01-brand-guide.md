...
- Saber exatamente o que está comprando
- Receber atendimento próximo
...
A interface deve usar bastante espaço vazio, imagens limpas, composições organizadas e poucos elementos competindo pela atenção.
...
Enquanto os arquivos oficiais não estiverem importados, utilizar uma base semântica semelhante a:

- Fundo principal: marfim ou off-white
- Superfície: branco quente
- Destaque suave: rosé queimado
- Apoio: nude ou taupe
...
- Texto nunca deve perder contraste
...
- Não usar letras excessivamente espaçadas em parágrafos
...
- Esticar
- Recolorir sem critério
- Aplicar sombra forte
...
- Reflexos estourados
- Fotos escuras
- Imagens com qualidade desigual
...
- Preço
- Disponibilidade
- Selo somente quando verdadeiro
- Ação clara
...
- Só utilizar quando o dado for verdadeiro
- Evitar mais de um selo por produto
...
- Zoom muito leve em imagens
- Transições de 200 a 400 ms
- Feedback suave em botões e filtros

Evitar:

- Elementos pulando
- Parallax agressivo
- Entrada de texto letra por letra
- Animações que atrasem a compra
- Efeitos contínuos sem função
...
- “Imperdível”
- “Você precisa”
- “Última chance” sem motivo real
- Excesso de diminutivos
- Linguagem infantil
...
“Escolha a sua favorita e fale com a gente.”
...
A marca precisa parecer delicada, organizada e confiável em cada detalhe, da fotografia ao atendimento.
