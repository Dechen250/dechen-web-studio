...
| Token | Hex | Uso |
|-------|-----|-----|
| `--brand-blue` | `#1B4F9C` | Primária, títulos, header |
| `--brand-blue-deep` | `#0E2F6B` | Fundo escuro, footer |
| `--brand-yellow` | `#F5C518` | Destaque, CTAs secundários, energia |
| `--brand-yellow-hot` | `#FFB800` | Hover / acento |
| `--surface` | `#F7F4EF` | Fundo claro (oficina clara, não cream genérico) |
| `--surface-warm` | `#E8DFD0` | Faixas alternadas |
...
- Sem cards no hero
- Cards apenas onde ajudam a escolher serviço
...
- “Elétrica, hidráulica, móveis e acabamentos.”
- “Peça um orçamento pelo WhatsApp.”

Exemplos a evitar:

- “Soluções inovadoras em facilities”
