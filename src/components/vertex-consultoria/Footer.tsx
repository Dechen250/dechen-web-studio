...
export function Footer() {
  return (
    <footer className="border-t border-[rgba(34,211,238,0.12)] bg-[#070B10] px-5 py-12 md:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row md:items-start">
          <div className="text-center md:text-left">
            ...
            <p className="mt-2 font-sans text-sm text-[#8B9AAB]">{siteInfo.tagline}</p>
          </div>
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-[rgba(34,211,238,0.1)] pt-8 sm:flex-row">
