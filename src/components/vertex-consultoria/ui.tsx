...
const variants = {
  primary:
    "bg-[#22D3EE] px-8 py-3.5 text-[#0B1118] shadow-[0_0_24px_rgba(34,211,238,0.25)] hover:bg-[#67E8F9] hover:shadow-[0_0_32px_rgba(34,211,238,0.35)] active:scale-[0.98]",
  secondary:
...
export function FadeIn({
  ...
  return (
    <div className={`animate-[fadeInUp_0.75s_ease-out_both] ${className}`}>
      {children}
    </div>
  );
}
