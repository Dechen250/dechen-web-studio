...
export function Footer() {
  return (
    <footer className="border-t border-[#D5E4E0] bg-[#E8F3F0]/40 px-5 py-12 md:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row md:items-start">
          <div className="text-center md:text-left">
            ...
            <p className="mt-2 font-sans text-sm text-[#5A6F6A]">{siteInfo.tagline}</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-3 md:items-end">
            ...
            <p className="font-sans text-sm text-[#5A6F6A]">{siteInfo.address.full}</p>
          </div>
        </div>

        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-[#D5E4E0] pt-8 sm:flex-row">
