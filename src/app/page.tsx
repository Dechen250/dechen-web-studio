...
function SocialIconLink({
  ...
  return (
    <a
      ...
      aria-label={label}
      className={`flex h-10 w-10 items-center justify-center rounded-full border border-[#262626] bg-[#101010]/60 text-[#A1A1AA] ${TRANSITION} hover:border-[#0070F3]/40 hover:bg-[#101010] hover:text-white ${FOCUS}`}
    >
      {children}
    </a>
  );
                ...
                <div>
                  ...
                  <div className="mt-8 flex flex-col items-start gap-4">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`inline-flex items-center gap-2.5 rounded-full bg-[#25D366] px-5 py-3 text-sm font-semibold text-white ${TRANSITION} hover:brightness-110 ${FOCUS}`}
                    >
                      <svg
                        className="h-5 w-5"
                        viewBox="0 0 24 24"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`inline-flex items-center gap-2.5 text-sm text-[#A1A1AA] ${TRANSITION} hover:text-white ${FOCUS}`}
                    >
          ...
          <div className="flex flex-col items-center justify-between gap-8 sm:flex-row sm:items-start">
            ...
            <ul className="flex items-center gap-3">
              <li>
                <SocialIconLink
                  href={agency.social.instagram}
                  label="Instagram da Dechen Web Studio"
                >
                  <InstagramGlyph className="h-4 w-4" />
                </SocialIconLink>
              </li>
